...
module.exports = {
    getUserDepositHis: (req, res) => {
        const username = req.user.username
        getUserDepositHis(username, (err, results) => {
            if (err) {
                console.log(err);
                return;
            }
    ...
    getUserWitdrawalHis: (req, res) => {
        const username = req.user.username
        getUserWitdrawalHis(username, (err, results) => {
            if (err) {
                console.log(err);
                return;
            }
    ...
    getAllDepositHis: (req, res) => {
        const user = req.user
        getAllDepositHis(user, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
    ...
    getAllWithDrawalHis: (req, res) => {
        getAllWithDrawalHis(req.user, (err, results) => {
            if(err){
                console.log(err);
                return;
            }
