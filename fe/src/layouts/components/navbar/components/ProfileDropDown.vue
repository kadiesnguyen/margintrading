      ...
      <vs-dropdown-menu class="vx-navbar-dropdown">
        <ul style="min-width: 9rem">
          ...
          <li
            ...
            <span class="ml-2">{{ $t('doimatkhau') }}</span>
          </li>
          ...
          <li
            ...
            <span class="ml-2">{{ $t('dangxuat') }}</span>
          </li>
        </ul>
      </vs-dropdown-menu>
    </vs-dropdown>
      ...
      <div class="vx-row">
            ...
            <div class="vx-col w-full mb-base">
                <div class="centerx labelx mb-4">
                    <vs-input class="w-full" :label="$t('matkhaumoi')" v-model="newpass"/>
                </div>
                <div class="centerx labelx mb-4">
                    <vs-input class="w-full" :label="$t('nhaplaimatkhaumoi')" v-model="reNewPass"/>
                </div>

            </div>
            <vs-button type="filled" @click.prevent="changPass()" class="mt-5 m-auto">{{ $t('dongy') }}</vs-button>
        </div>
    </vs-prompt>
